...
function getClassSection(classId = null) 
{
	if(classId) {
		...
		$.ajax({
			url: 'section/fetchSectionTable/' + classId,
			type: 'post',		
			...
			$.ajax({
				...
				success:function(response) {
					if(response.success == true) {					
						...
						$("#manageSectionTable").load('section/fetchUpdateSectionTable/' + classId);
...
function editSection(sectionId = null, classId = null)
{
	if(sectionId && classId) {
		...
		$.ajax({
			url: 'section/fetchSectionByClassSection/'+classId+'/'+sectionId,
			type: 'post',
			dataType: 'json',
			success:function(response) {
